//Referencia :https://processing.org/reference/frameRate.html
//           : https://p5js.org/es/reference/#/p5/frameRate
/*frameRate
   Especifica el número de cuadros mostrados por segundo.
   función frameRate(30), tratará de refrescar 30 veces por segundo. Si el procesador no es lo suficientemente
    rápido para mantener la tasa especificada, la tasa de cuadros
   por segundo no será lograda. Se recomienda definir la tasa de cuadros por segundo dentro de setup().
 frameCount
The system variable frameCount contains the number of frames displayed since the program started. */
